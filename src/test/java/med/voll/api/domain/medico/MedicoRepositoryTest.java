...
@DataJpaTest
//Anotação para configurar o Spring para não substituir as configurações do meu db por um db em memória
    @AutoConfigureTestDatabase(replace = AutoConfigureTestDatabase.Replace.NONE)
//Anotação para configurar o Spring para usar o profile test do application.properties
     @ActiveProfiles("test")
class MedicoRepositoryTest {
    ...
    @Test
    @DisplayName("Deveria devolver médico ele está disponível na data")
